...
function _M:init()
    ...
    -- Scoring is currently unimplemented, and addons aren't currently useful.
...
function _M:uiStats(uis)
    ...
    local logoff = Textzone.new{text="#LIGHT_BLUE##{underline}#Logout#{normal}#", auto_height=true, width=50, fct=function() self:logout() end}
