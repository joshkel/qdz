...
newTalentType{ type="basic/proficiencies", name = "proficiencies", description = "Proficiencies are various (mostly) mundane skills. Most beings learn these through training and practice. As a qi dao zei, you can instead be granted them through the abilities you absorb from your foes."}
